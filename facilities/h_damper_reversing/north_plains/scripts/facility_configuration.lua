...
function initValues()
  ...
  BLOWER_GROUP_ZONE_IDS['01'] = uid(1,5)
  BLOWER_GROUP_ZONE_IDS['02'] = uid(6,10)
  BLOWER_GROUP_ZONE_IDS['03'] = uid(11,15)
  BLOWER_GROUP_ZONE_IDS['04'] = uid(16,20)
  ZONE_IDS = uid(20)
  ZONE_PROBE_IDS = {'A','B'}
...
function defaultSettings()
  ...
  settings["FacilityName"] = "NORTH PLAINS"
...
function updateLastValidTemps()
  ...
  for i,bl_id in ipairs(BLOWER_IDS) do
    ...
    updateLVTemp(str__ambient..bl_id)
...
function updateDampers()
  for i,zn_id in ipairs(ZONE_IDS) do
    ...
    damperControl(_G[str__DAMPER_..dmpr_id],dmpr_id,tempAvgForZones({zn_id},ZONE_PROBE_IDS),spForZone(zn_id))
  end
end
...
function updateAlarms()
  ...
  for i,bl_id in ipairs(BLOWER_IDS) do
    blowerFaultAlarm(_G[str__BLOWER_..bl_id],bl_id,'Blower '..tonumber(bl_id))
