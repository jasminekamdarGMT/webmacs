...
function TestWebmacsScripts:test_zone_controls()
  ...
  for i, zone_id in pairs(zone_ids) do
    ...
    lu.assertEquals(test_files[webmacs_db_path .. _G['ZONE_'..zone_id]["file_name"]], "Date/Time, Zone, Temperature A, PFRP Time \n")
    ...
    reg['zone'..zone_id..'pfrptime'] = 1846
    updateZones()
    lu.assertEquals(test_files[webmacs_db_path .. _G['ZONE_'..zone_id]["file_name"]], "Date/Time, Zone, Temperature A, PFRP Time \n01/01/2017 12:00:00, "..tonumber(zone_id)..", 128, 1846\n")
