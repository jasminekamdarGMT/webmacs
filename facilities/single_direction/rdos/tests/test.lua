...
function TestWebmacsScripts:test_zone_controls()
  for i, zone_id in pairs(zone_ids) do
    ...
    lu.assertEquals(test_files[webmacs_db_path .. _G['ZONE_'..zone_id]["file_name"]], "Date/Time, Zone, Temperature A, Temperature B, Blower Run, PFRP Time \n")
    ...
    updateZones()
    lu.assertEquals(test_files[webmacs_db_path .. _G['ZONE_'..zone_id]["file_name"]], "Date/Time, Zone, Temperature A, Temperature B, Blower Run, PFRP Time \n01/01/2017 12:00:00, "..tonumber(zone_id)..", 128, 135, On, 0\n")
    ...
    updateZones()
    lu.assertEquals(test_files[webmacs_db_path .. _G['ZONE_'..zone_id]["file_name"]], "Date/Time, Zone, Temperature A, Temperature B, Blower Run, PFRP Time \n01/01/2017 12:00:00, "..tonumber(zone_id)..", 128, 135, On, 0\n01/01/2017 12:00:00, "..tonumber(zone_id)..", 128, 135, Off, 120\n")
    lu.assertEquals(reg['zone'..zone_id..'print'], 7200)
